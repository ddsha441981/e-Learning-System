...
<%@ include file="Trainer/header.jsp" %>

<!--header end-->

<!--sidebar start-->

<%@ include file="Trainer/leftMenu.jsp" %>
...
<section id="main-content">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="get" action="submitingTrinerChangePassword" novalidate="novalidate">
 ...
 <!-- footer -->
		  ...
		  <%@ include file="Trainer/footer.jsp" %>
